        ...
        <div style={{ background:'#0A1628', borderRadius:'14px', padding:'28px', border:'1px solid #1E293B' }}>
          <form onSubmit={handleSubmit}>
            ...
            <button type="submit" disabled={loading || !emailOk}
              style={{ width:'100%', padding:'13px', background:!emailOk||loading?'#1E293B':'linear-gradient(135deg,#0F766E,#065F46)', color: !emailOk||loading?'#475569':'#fff', border:'none', borderRadius:'10px', fontSize:'14px', fontWeight:'600', cursor:!emailOk||loading?'not-allowed':'pointer', marginBottom:'16px' }}>
